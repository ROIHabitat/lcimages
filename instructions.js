...
var cutout = 6; //set value to page to be removed
...
var pages= [
	...
	"The base payment is $0.10 per photo. Accuracy and attention to detail is important. You will be paid a bonus of up to $0.40 per photo if your classification is close to all other accepted classifications of that photo.<br><br>"+
	...
	"There are examples at the end of these instructions for each of these 4 types. Please examine these carefully.<br><br>"+
	"<u>Please note: this HIT is not optimized for touch devices and is best done with a mouse or other pointer device</u>",
	//1	
	...
	//3
	"<figure style='float:right'><img src='"+imgfldr+"lc.gif' height='250px'></figure><br>"+
	"The example on the right shows a classification with areas of crop (yellow), grass (orange), and trees (green).<br><br>"+
	"Notice how some cells along the edges have two different land cover types in them. These cells should be identified as the type that covers more of the cell.",
	//4
	...
	"Once the classification is at least 95% complete, a submit button will appear at the bottom of the page. Clicking this button will submit the HIT. Failing or circumventing this requirement will result in the HIT being rejected.<br><br>"+
	"Recall that a bonus payment is available based on the accuaracy of your land classification relative to classifications by other users.<br>"+
	"Classifications that are too different from the expected results or that do not reflect variations in the photo will be rejected entirely",
	//5
	...
	"<tr><td><img src='"+imgfldr+"crop4.jpg'></td><td>This whole image is crop. Lines from farming equipment are only visible in one corner.</td></tr>"+
	"<tr><td><img src='"+imgfldr+"crop5.jpg'></td><td>Two different crops in black and white.</td></tr></table>",
	//8
	"<p>Grass</p><br>"+
	"For the purpose of this survey, <b>grass</b> is any open area without tree cover <i>not being used in crop production.</i><br><br>"+
	"<table class='infotable'>"+
	...
	"<tr><td><img src='"+imgfldr+"Grass4.jpg'></td><td>Grass surrounding some barns and a pond (wetland). There is crop visible on the left.</td></tr></table>",
	//9
	"<p>Trees</p><br>"+
	...
	//11
	"<p>Examples</p><br>"+
	"Below are two examples of classifications"+
	"<table class='infotable'>"+
	"<tr><td><img src='"+imgfldr+"lcex1.gif'></td><td>Example showing all 4 types. Wetlands are dark areas. <br>Crop has markings from equipment. <br>Grass is open areas along edges of crop. <br>Trees surround wetlands.</td></tr>"+
	"<tr><td><img src='"+imgfldr+"lcex2.gif'></td><td>Crop can be seen on the left, with some evidence of machinery along the edge. Grass is all open areas, and areas where the trees appear very small. Large trees have a distinct texture and create shadows.</td></tr></table>",
];
